...
public class Cr2Tables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Step__ModerationProcess__step = new ExecutorPropertyWithImplementation("ModerationProcess", Types._Step, 0, new EcoreLibraryOppositeProperty(Cr2Package.Literals.MODERATION_PROCESS__STEP));
		public static final ExecutorProperty _Step__ValidationStep__nextApprove = new ExecutorPropertyWithImplementation("ValidationStep", Types._Step, 1, new EcoreLibraryOppositeProperty(Cr2Package.Literals.VALIDATION_STEP__NEXT_APPROVE));
		public static final ExecutorProperty _Step__ValidationStep__nextReject = new ExecutorPropertyWithImplementation("ValidationStep", Types._Step, 2, new EcoreLibraryOppositeProperty(Cr2Package.Literals.VALIDATION_STEP__NEXT_REJECT));
