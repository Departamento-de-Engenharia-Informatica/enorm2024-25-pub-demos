 ...
 *   <li>{@link pt.ipp.isep.mei.enorm.pam.cr2.Comment#getModerationProcess <em>Moderation Process</em>}</li>
 *   <li>{@link pt.ipp.isep.mei.enorm.pam.cr2.Comment#isHasModerationProcess <em>Has Moderation Process</em>}</li>
 * </ul>
 *
...
public interface Comment extends UserFeedback {
	...
	/**
	 * Sets the value of the '{@link pt.ipp.isep.mei.enorm.pam.cr2.Comment#getModerationProcess <em>Moderation Process</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see pt.ipp.isep.mei.enorm.pam.cr2.Cr2Package#getComment_HasModerationProcess()
