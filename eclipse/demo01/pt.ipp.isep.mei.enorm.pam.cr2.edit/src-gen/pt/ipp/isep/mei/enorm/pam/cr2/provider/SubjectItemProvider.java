...
public class SubjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Cr2Package.Literals.SUBJECT__USERFEEDBACK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(Cr2Package.Literals.SUBJECT__USERFEEDBACK, Cr2Factory.eINSTANCE.createComment()));

		newChildDescriptors.add(
				createChildParameter(Cr2Package.Literals.SUBJECT__USERFEEDBACK, Cr2Factory.eINSTANCE.createReview()));
	}
